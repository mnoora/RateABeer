...
describe "Beerlist page" do
  ...
  it "when style clicked, shows beers in alphabetical order by style", js:true do
    visit beerlist_path
  ...
  it "when brewery clicked, shows beers in alphabetical order by brewery", js:true do
    visit beerlist_path
